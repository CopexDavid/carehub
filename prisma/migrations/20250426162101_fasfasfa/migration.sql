...
INSERT INTO "new_AssistantSettings" ("accountId", "assistantId", "createdAt", "errorMessage", "id", "isConfigured", "maxTokens", "model", "name", "openAiKey", "prompt", "status", "temperature", "updatedAt") SELECT "accountId", "assistantId", "createdAt", "errorMessage", "id", "isConfigured", "maxTokens", "model", "name", "openAiKey", "prompt", "status", "temperature", "updatedAt" FROM "AssistantSettings";
